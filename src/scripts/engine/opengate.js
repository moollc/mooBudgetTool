...
(function () {
    ...
    /* Defect 3 fix, 2026-07-30: only Jamaica actually converts its numbers into local currency
       (see the "region === 'Jamaica'" multiply in _expandIndex below). Every other region's rate
       is a USD-scaled figure. Trinidad, Barbados and Guyana already labelled that honestly as USD.
       The Phase 197 regions below did not, so a rate of 380 was shown as "380 INR" when it is really
       380 USD, off by roughly 85x and reading as plausible. Relabelled to USD so the label matches
       the number. Real per-region FX conversion is a bigger job and is not attempted here. */
    var OG_CURRENCIES = {
        'USA': 'USD', 'UK': 'GBP', 'Canada': 'CAD', 'Australia': 'AUD',
        'Jamaica': 'JMD', 'Trinidad': 'USD', 'Barbados': 'USD', 'Guyana': 'USD',
        /* Phase 197, Regional Expansion. Relabelled USD, see note above: these carried
           local-currency labels on USD-scaled numbers, e.g. India showed "380 INR" for a
           figure that is really 380 USD. */
        'India': 'USD', 'Thailand': 'USD', 'Philippines': 'USD', 'Vietnam': 'USD',
        'Poland': 'USD', 'Mexico': 'USD', 'Brazil': 'USD', 'Colombia': 'USD', 'South Africa': 'USD'
    };
    ...
    var _MASTER_CREW_INDEX = [
        { "description": "Director", "unit": "Day", "baseRate": 1200, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.8, "Canada": 0.77, "Australia": 0.68, "India": 0.40, "Thailand": 0.60, "Philippines": 0.66, "Vietnam": 0.74, "Poland": 0.92, "Mexico": 0.54, "Brazil": 0.60, "Colombia": 0.40, "South Africa": 0.58 }, "intelligence": "Director creative leadership labor on shoot days. Prep, development and overall deals are almost never priced as straight shoot days; treat this as an on-set day anchor, not a full engagement quote." },
        ...
        { "description": "Producer", "unit": "Day", "baseRate": 950, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.8, "Canada": 0.75, "Australia": 0.68, "India": 0.38, "Thailand": 0.60, "Philippines": 0.63, "Vietnam": 0.71, "Poland": 0.89, "Mexico": 0.53, "Brazil": 0.63, "Colombia": 0.42, "South Africa": 0.58 }, "intelligence": "Producer labor on the production. Development, packaging, prep and wrap weeks are commonly negotiated outside a simple shoot-day multiply; vendor spend and crew hires are separate budget lines." },
        { "description": "Executive Producer", "unit": "Day", "baseRate": 3000, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.8, "Canada": 0.75, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Oversight and packaging credit role, not a standard crew day hire. Often a flat fee, points or nominal days; this 3000/day anchor misleads badly if stretched across a long schedule. Confirm deal structure before budgeting." },
        { "description": "Line Producer", "unit": "Day", "baseRate": 867, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.85, "Canada": 0.8, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Hands-on budget, schedule and vendor management labor. Prep and wrap weeks are commonly billed on top of shoot days. Production office, payroll services and accounting are separate overhead lines." },
        ...
        { "description": "Director of Photography (DP)", "unit": "Day", "baseRate": 950, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 1.2, "Canada": 0.78, "Australia": 0.68, "India": 0.40, "Thailand": 0.45, "Philippines": 0.65, "Vietnam": 0.62, "Poland": 0.94, "Mexico": 0.55, "Brazil": 0.63, "Colombia": 0.42, "South Africa": 0.65 }, "intelligence": "Cinematographer labor only. Camera body, lenses, filters and the camera package rental are almost always separate equipment lines. Prestige indie and commercial work often fly-in a DP; local hire is more typical on volume TV. Do not budget one number and assume a full shooting package is included." },
        { "description": "Camera Operator", "unit": "Day", "baseRate": 550, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.85, "Canada": 0.8, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Camera operating labor only. Camera body, lenses and the camera package rental are separate equipment lines, usually far larger than this day rate. Do not budget labor and assume the shooting package is included." },
        { "description": "1st Assistant Camera (Focus)", "unit": "Day", "baseRate": 450, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.85, "Canada": 0.82, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Focus puller labor only. Follow focus, iris and lens support on set. Personal kit or box rental for follow-focus, monitors and tools is often extra; the camera package is a separate rental line." },
        { "description": "2nd Assistant Camera", "unit": "Day", "baseRate": 350, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.8, "Canada": 0.77, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Loader and camera support labor on set. Media, batteries and accessories usually sit in the camera package rental, not this day rate." },
        { "description": "Digital Imaging Tech (DIT)", "unit": "Day", "baseRate": 590, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.95, "Canada": 0.85, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "On-set data wrangling and playback labor, not post colorist work. DIT cart, calibrated monitors, RAID storage and power distro are commonly a kit or box rental on top of this day rate. Fly-in DITs are typical when the camera package is high-end or the schedule is tight." },
        ...
        { "description": "Drone Operator", "unit": "Day", "baseRate": 500, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.9, "Canada": 0.85, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Licensed drone pilot labor only. Aircraft, batteries and gimbal are a separate drone package rental line. Local licensing, insurance, a spotter or VO and half-day or per-flight hires are common extras beyond one shoot day." },
        { "description": "Camera Utility", "unit": "Day", "baseRate": 300, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.80, "Canada": 0.75, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Camera department utility labor; cables, lens swaps and rigging support on set. Camera package and specialty rigs are separate equipment rental lines." },
        { "description": "Unit Production Manager (UPM)", "unit": "Day", "baseRate": 911, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.9, "Canada": 0.85, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Unit production management labor on the show. Prep and wrap weeks before and after the shoot block are standard and often billed separately. Production office, payroll and vendor overhead are separate lines." },
        { "description": "1st Assistant Director (1st AD)", "unit": "Day", "baseRate": 867, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.85, "Canada": 0.8, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "First AD set leadership labor; schedule, safety and crew coordination on shoot days. Prep days before the block are standard and commonly billed in addition to shoot days, not inside this rate." },
        { "description": "2nd Assistant Director", "unit": "Day", "baseRate": 557, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.85, "Canada": 0.75, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Second AD on-set support labor; talent and background, logistics and paperwork. Prep and wrap days are often billed beyond shoot days when cast, locations or crowd scenes are involved." },
        { "description": "2nd 2nd AD", "unit": "Day", "baseRate": 400, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.80, "Canada": 0.7, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Third AD or 2nd 2nd AD labor only: background, lockups and set traffic under the AD team. Overtime and turnaround are the usual overruns on this tier because ADs are first in and last out; walkie packages and basecamp logistics sit on other lines." },
        { "description": "Key PA", "unit": "Day", "baseRate": 300, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.80, "Canada": 0.65, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Key production assistant labor only: leads the PA team on set or basecamp. Overtime and turnaround drive most overruns because PAs open and close the day; van or vehicle allowance and mileage are separate if they apply." },
        { "description": "Set PA", "unit": "Day", "baseRate": 250, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.80, "Canada": 0.65, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Set production assistant labor only: lockups, background wrangling and on-set runs under the AD/PA team. Overtime and turnaround are the usual overrun risk on long shoot days; crafty, walkies and transport sit on other lines." },
        { "description": "Office PA", "unit": "Day", "baseRate": 250, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.8, "Canada": 0.65, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Office or production office PA labor only: phones, paperwork and office runs, not set lockups. Overtime still bites when call sheets and wrap run late; office supplies, courier and software sit on separate production lines." },
        { "description": "Truck PA", "unit": "Day", "baseRate": 250, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.80, "Canada": 0.65, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Truck or basecamp PA labor only: load-ins, truck runs and basecamp support, not a dedicated production driver day. Overtime and turnaround overrun on early load and late wrap; van or vehicle allowance, mileage and truck rental are separate lines." },
        { "description": "Gaffer", "unit": "Day", "baseRate": 600, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.85, "Canada": 0.78, "Australia": 0.68, "India": 0.35, "Thailand": 0.33, "Philippines": 0.29, "Vietnam": 0.29, "Poland": 0.68, "Mexico": 0.46, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Chief lighting electrician labor only. Lamps, cable, distro and the lighting truck or package rental are separate equipment lines, often the largest electric cost. Generator operator and fuel may also be separate if genny is on the show." },
        { "description": "Best Boy Electric", "unit": "Day", "baseRate": 450, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.8, "Canada": 0.75, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Second electric labor only: runs the lighting crew under the gaffer. Lamps, cable, distro, expendables and the lighting truck or package rental are separate equipment lines and usually dwarf this labor rate." },
        { "description": "Electrician", "unit": "Day", "baseRate": 350, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.75, "Canada": 0.77, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Set lighting electrician labor only: hangs and powers units under the gaffer and best boy. Lamps, cable, distro, expendables and the lighting package or truck rental are separate lines and often cost more than floor electric labor." },
        { "description": "Key Grip", "unit": "Day", "baseRate": 600, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.85, "Canada": 0.78, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Department head labor only. Grip truck, stands, dollies, rigging and expendables are almost always billed as equipment rental separate from this day rate. Do not treat Key Grip as a bundled grip package." },
        { "description": "Best Boy Grip", "unit": "Day", "baseRate": 450, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.80, "Canada": 0.75, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Second grip labor only: runs the grip crew under the key grip. Grip truck, stands, flags, hardware, expendables and specialty rigging packages are separate rental lines and usually outweigh this labor rate." },
        { "description": "Dolly Grip", "unit": "Day", "baseRate": 450, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.85, "Canada": 0.78, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Dolly grip labor only: operates and lays track for the camera dolly under the key grip. Dolly, track, crane and remote head rentals are separate equipment lines and often cost more than this labor day." },
        { "description": "Grip", "unit": "Day", "baseRate": 350, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.75, "Canada": 0.77, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Floor grip labor only: stands, diffusion, safety and camera support under the key and best boy grip. Grip truck, hardware, expendables and specialty rigs are separate rental lines and usually outweigh floor grip labor." },
        { "description": "Generator Operator", "unit": "Day", "baseRate": 350, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.80, "Canada": 0.8, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Generator operator labor only: runs and monitors the unit power plant on set. Genny rental, fuel, cable and distro from the plant are separate equipment and consumable lines, not inside this rate." },
        { "description": "Sound Mixer", "unit": "Day", "baseRate": 950, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.9, "Canada": 0.85, "Australia": 0.68, "India": 0.35, "Thailand": 0.38, "Philippines": 0.2, "Vietnam": 0.31, "Poland": 0.58, "Mexico": 0.34, "Brazil": 0.38, "Colombia": 0.26, "South Africa": 0.41 }, "intelligence": "Production recordist labor only. Mixer, wireless mics, boom mics and the sound kit or cart are commonly a kit rental on top of this day rate. Post sync, ADR and mix are separate post lines, not this role." },
        { "description": "Boom Operator", "unit": "Day", "baseRate": 450, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.85, "Canada": 0.8, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Boom labor on set. Wireless transmitters, receivers and the production sound kit usually sit with the mixer package, not inside this day rate. A personal boom pole is minor; do not assume the full sound package is covered here." },
        { "description": "Sound Utility", "unit": "Day", "baseRate": 300, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.8, "Canada": 0.75, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Sound utility labor only: supports the production mixer with wiring, plants and set audio runs. Timecode gear, comteks, radio mic packages and the rest of the sound cart rental are the sound package line, not this rate." },
        { "description": "Production Designer", "unit": "Day", "baseRate": 750, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.9, "Canada": 0.85, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Design leadership labor only. Set construction, scenic paint, props builds and art department purchases are separate material and labor lines. Prep weeks and scout days are often negotiated outside a straight shoot-day count." },
        { "description": "Art Director", "unit": "Day", "baseRate": 544, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.85, "Canada": 0.77, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Art department design and supervision labor only. Set dressing, props buy and rental, construction materials, scenic paint and greens are all separate art department lines that this rate does not cover." },
        { "description": "Set Decorator", "unit": "Day", "baseRate": 550, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.90, "Canada": 0.75, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Decorator labor only. Furnishings, drapery, plants and dressing rentals or purchases are separate art department spend. Set dressers and swing sets are additional labor lines, not bundled in this rate." },
        { "description": "Set Dresser", "unit": "Day", "baseRate": 350, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.75, "Canada": 0.75, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Set dressing labor only, placing and striking dressing on set. The dressing itself, whether bought or rented, is a separate art department line and can far exceed this day rate." },
        { "description": "Props Master", "unit": "Day", "baseRate": 550, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.85, "Canada": 0.77, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Props department supervision labor only. Prop purchase, rental and fabrication are separate art department lines, not included in this rate." },
        { "description": "Assistant Props", "unit": "Day", "baseRate": 350, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.75, "Canada": 0.75, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Support labor under the props master, distinct from that department head rate. Prop purchase and rental remain separate art department lines, and prep or wrap days spent pulling and returning stock beyond shoot days should be scheduled separately." },
        { "description": "Costume Designer", "unit": "Day", "baseRate": 750, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.85, "Canada": 0.8, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Design labor only, and this role is prep-heavy with fittings and shopping days that fall before the shoot block. Garment purchase, rental and alterations are separate wardrobe lines, not included here." },
        { "description": "Wardrobe Stylist", "unit": "Day", "baseRate": 550, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.85, "Canada": 0.75, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "On-set wardrobe labor only. Garment purchase or rental, alterations, cleaning between wear days and multiples for stunts or continuity are all separate wardrobe lines." },
        { "description": "Wardrobe Assistant", "unit": "Day", "baseRate": 300, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.80, "Canada": 0.75, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Support labor under the wardrobe stylist, distinct from that rate. Cleaning between wear days and laundry runs are separate wardrobe lines, and set days do not cover prep or wrap time spent pulling and returning stock." },
        { "description": "Makeup Artist (Key)", "unit": "Day", "baseRate": 550, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.85, "Canada": 0.77, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Key makeup labor only. Kit or box rental for brushes, palettes and consumables is commonly charged on top of the day rate. Prosthetics, wigs and special materials are separate purchases, not this line." },
        { "description": "Hair Stylist (Key)", "unit": "Day", "baseRate": 550, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.85, "Canada": 0.77, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Hair labor only. Kit fee, consumables, wigs and specialty pieces are separate lines and the kit can exceed the labor cost on this rate." },
        { "description": "Makeup/Hair Assistant", "unit": "Day", "baseRate": 300, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.80, "Canada": 0.75, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Support labor under the key hair or makeup artist, distinct from that rate. Consumables and any specialty prosthetics or SFX makeup remain separate lines regardless of who applies them." },
        { "description": "Editor", "unit": "Day", "baseRate": 850, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.85, "Canada": 0.78, "Australia": 0.68, "India": 0.40, "Thailand": 0.39, "Philippines": 0.29, "Vietnam": 0.48, "Poland": 0.78, "Mexico": 0.47, "Brazil": 0.53, "Colombia": 0.35, "South Africa": 0.54 }, "intelligence": "Picture editing labor only. Edit suite rental, shared storage and media ingest or transcode are separate post facility lines. Post schedules usually run for weeks, not shoot days; multiplying this day rate by shoot days badly understates the real edit cost." },
        { "description": "Assistant Editor (AE)", "unit": "Day", "baseRate": 450, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.75, "Canada": 0.75, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Assistant editor labor only; conforms, prep and media management support. Edit suite, storage and archive are separate facility lines. Post weeks often far exceed the shoot; do not budget AE days as shoot days only." },
        { "description": "Post-Production Supervisor", "unit": "Day", "baseRate": 650, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.9, "Canada": 0.85, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Post pipeline oversight labor across the full post period. Vendors, deliverables and QC are coordinated roles, not shoot-day crew. Budget for weeks through final delivery, not the camera schedule alone." },
        { "description": "VFX Artist", "unit": "Day", "baseRate": 750, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.85, "Canada": 0.85, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "VFX artist labor only. Visual effects are normally bid per shot, per sequence or as a vendor package, not straight day rates. Render farm time, software licenses and vendor bids are separate lines, often the largest VFX cost." },
        { "description": "VFX Supervisor", "unit": "Day", "baseRate": 1100, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.9, "Canada": 0.9, "Australia": 0.68, "India": 0.40, "Thailand": 0.39, "Philippines": 0.28, "Vietnam": 0.50, "Poland": 0.69, "Mexico": 0.45, "Brazil": 0.52, "Colombia": 0.36, "South Africa": 0.49 }, "intelligence": "VFX supervision labor only. Shot counts, vendor bids and per-shot or package pricing drive real VFX spend. Render capacity, licenses and outsourced vendor work are separate budget lines; day rates alone badly understate VFX." },
        { "description": "Sound Designer", "unit": "Flat", "baseRate": 900, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.85, "Canada": 0.85, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Sound design creative labor on a flat package basis. Mix stage, ADR booth and foley facility time are separate post lines, not inside this flat fee. Final mix and deliverables are additional vendor or facility costs." },
        ...
        { "description": "Music Supervisor", "unit": "Flat", "baseRate": 300, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.8, "Canada": 0.8, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Music supervisor fee for search, clearance workflow and supervision only. Sync and master licenses, composer scores and library or needle-drop costs are separate and usually far larger than this flat fee. Do not treat this line as the music budget." },
        { "description": "Cast - Lead", "unit": "Day", "baseRate": 1500, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.85, "Canada": 0.8, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "On camera performance labor for the shoot day only. Usage and buyout by territory and term, agent commission, residuals or reuse fees and fitting or travel days sit on separate lines and are the most commonly missed cost in the whole index." },
        { "description": "Cast - Supporting", "unit": "Day", "baseRate": 1000, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.8, "Canada": 0.8, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "On camera performance labor for the shoot day only. As with lead cast, usage and buyout, agent commission and any reuse or residual terms are separate and can exceed the day rate itself." },
        { "description": "Location Manager", "unit": "Day", "baseRate": 650, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.85, "Canada": 0.8, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Location logistics labor only. Site fees, permits, police, fire, parking and holding costs are separate location lines. Scout and prep days are often billed in addition to shoot days; confirm whether this rate is per shoot day or includes scouting." },
        { "description": "Location Scout", "unit": "Day", "baseRate": 450, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.8, "Canada": 0.75, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Scouting labor only. Location fees, permits, parking, security, cleaning and restoration are their own lines and typically dwarf the scouting cost." },
        ...
        { "description": "Production Driver", "unit": "Day", "baseRate": 250, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.8, "Canada": 0.65, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Dedicated production driver (passenger van/sprinter, not grip truck). USA mid ~$200-$300/day from PA/driver day bands. Multipliers proxy Truck PA." },
        { "description": "Catering (Per Head)", "unit": "Flat", "baseRate": 45, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 1.1, "Canada": 0.9, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "This is a per head rate, not a day rate, so it must be multiplied by crew count and meal count to reach real cost. Craft service is a separate line covering snacks and drinks between meals, not this one." },
        ...
        { "description": "Craft Service", "unit": "Day", "baseRate": 300, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.8, "Canada": 0.8, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Covers snacks, drinks and between meal service labor and supply for the day, separate from Catering (Per Head), which is the sit down meal line." },
        { "description": "Script Supervisor", "unit": "Day", "baseRate": 550, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.85, "Canada": 0.80, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Continuity and timing labor on set. Prep, read-through and turnaround days are often negotiated separately from shoot days. No kit rental, but do not confuse this day rate with hourly script supervision on tight schedules." },
        { "description": "Production Accountant", "unit": "Day", "baseRate": 650, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.85, "Canada": 0.8, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Accounting labor only. Payroll service fees, accounting software and any audit are separate lines, not included in this day rate." },
        { "description": "Stunt Coordinator", "unit": "Day", "baseRate": 1100, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 1.1, "Canada": 1.00, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Coordinator labor only; almost always bespoke negotiation. Stunt performers, rigging, pads, medic and rehearsal days are separate lines. Insurance and safety equipment are not included in this day rate." },
        { "description": "Publicist", "unit": "Day", "baseRate": 600, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.85, "Canada": 0.78, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Publicity labor only. Unit stills, EPK crew and press junket costs are separate lines, not included in this fee." },
        { "description": "Colorist (Hourly)", "unit": "Hour", "baseRate": 85, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 1.2, "Canada": 1.1, "Australia": 0.68, "India": 0.38, "Thailand": 0.24, "Philippines": 0.19, "Vietnam": 0.30, "Poland": 0.61, "Mexico": 0.42, "Brazil": 0.46, "Colombia": 0.31, "South Africa": 0.51 }, "intelligence": "CORRECTED 2026-07-28. Was $800/hr, a day rate typed into an hourly field, billing 10x real cost. Professional colorist hourly benchmarks ~$81/hr (YunoJuno 2026); job market $16-64/hr. Renamed from Colorist to disambiguate from the Day entry, which search could not tell apart." },
        { "description": "Copywriter (Pitch/Treatment)", "unit": "Flat", "baseRate": 750, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.9, "Canada": 0.85, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Writing labor for the pitch or treatment stage, done before the job is won and often not recovered if the pitch loses. This is prep phase work with no shoot day mapping." },
        { "description": "Casting Director", "unit": "Day", "baseRate": 650, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.85, "Canada": 0.85, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Fee covers the search and casting sessions only. Casting studio hire, reader, session recording and talent expenses are separate lines, not included here." },
        { "description": "Storyboard Artist", "unit": "Day", "baseRate": 600, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.85, "Canada": 0.77, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Drawing labor for the pitch or pre-production stage, often at a reduced pitch rate and not recovered if the job does not go ahead. Licensed reference or stock imagery used for the boards sits on a separate line." },
        ...
        { "description": "Pitch Deck Designer", "unit": "Flat", "baseRate": 800, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.9, "Canada": 0.9, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Design labor for the pitch document, speculative work that goes unpaid if the pitch loses. Stock imagery and licensed fonts used in the deck are separate lines." },
        { "description": "Researcher", "unit": "Day", "baseRate": 250, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.8, "Canada": 0.75, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Research labor for the pitch or development stage, frequently unrecovered if the project does not proceed. Database or archive access fees used for the research are separate lines." },
        ...
        { "description": "Concept Artist", "unit": "Day", "baseRate": 450, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.85, "Canada": 0.8, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Concept and visual development labor only. Software licenses and reference or stock assets may be separate lines. Concept art is prep work, usually budgeted before the shoot block, not as shoot days." },
        { "description": "Legal - Rights & Clearances", "unit": "Flat", "baseRate": 2500, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.9, "Canada": 0.9, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Fee covers the clearance work only, researching and documenting rights. Music sync, archival footage licences, talent releases and E&O insurance are separate lines and usually far larger than this fee." },
        ...
        { "description": "Security Guard", "unit": "Day", "baseRate": 150, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.7, "Canada": 0.7, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Single guard labor for the day. Headcount is often set by the permit or the insurer rather than by choice, and many markets bill a minimum call regardless of the hours actually worked." },
        { "description": "Medic / Set Nurse", "unit": "Day", "baseRate": 450, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.85, "Canada": 0.8, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "On set medic labor for the day, often mandated by the insurer or the nature of the stunts on the call sheet rather than optional. Minimum call hours may apply regardless of wrap time." },
        /* --- Expanded Roles (Phase 185 Expansion) --- */
        { "description": "Still Photographer", "unit": "Day", "baseRate": 750, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.85, "Canada": 0.8, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "On-set or unit still photography labor only. Often a half day or per-shoot hire rather than every shoot day. Image licensing, usage rights and publicity buyouts can be a separate negotiation beyond this day rate." },
        { "description": "Construction Coordinator", "unit": "Day", "baseRate": 850, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.85, "Canada": 0.75, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Construction supervision labor only. Lumber, hardware, scenic paint and shop time for the build crew are not in this rate and are separate construction lines that typically dwarf it." },
        { "description": "Sculptor", "unit": "Day", "baseRate": 700, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.8, "Canada": 0.85, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Construction department labor under the construction coordinator. Clay, foam, moulding supplies and workshop time are separate construction lines and typically dwarf the labor." },
        { "description": "Draftsperson", "unit": "Day", "baseRate": 600, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.8, "Canada": 0.8, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Technical drawing labor only, generally a prep-phase role ahead of the shoot block rather than a set day. Construction materials and shop time to build from these drawings are separate construction lines." },
        { "description": "Assistant Art Director", "unit": "Day", "baseRate": 450, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.85, "Canada": 0.85, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Support labor under the art director, distinct from that department head rate. This role often carries prep days building drawings and paperwork ahead of the shoot block, separate from set days, and set dressing or construction purchases remain their own art department lines. Rate corrected 2026-08-07: was 650, which placed the assistant above the art director. IATSE Local 800 sets the assistant at about 0.755 of the art director." },
        { "description": "Graphics Artist", "unit": "Day", "baseRate": 550, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.85, "Canada": 0.85, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Motion or still graphics labor only. Software licenses, stock assets and font or template purchases may be separate lines. Deliverable specs and revision rounds are often negotiated outside a single day count." },
        ...
        { "description": "Music Editor", "unit": "Day", "baseRate": 650, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.85, "Canada": 0.8, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Music editorial labor only; spotting, cuts and temp-to-final alignment. Composer fees, library or needle-drop licenses and the mix stage are separate music and post lines." },
        { "description": "Sound Editor", "unit": "Day", "baseRate": 750, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.85, "Canada": 0.85, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Dialogue and effects editorial labor only. ADR stage, foley and the final mix stage are separate facility lines. Post sound runs for weeks; do not map this day rate to shoot days only." },
        { "description": "Location Assistant", "unit": "Day", "baseRate": 350, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.8, "Canada": 0.8, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Support labor under the location manager or scout, distinct from that rate. Location fees, permits and site restoration remain separate lines regardless of who is on site." },
        { "description": "Lead Labourer", "unit": "Day", "baseRate": 400, "multipliers": { "USA": 1, "Jamaica": 0.28, "Trinidad": 0.37, "Barbados": 0.43, "Guyana": 0.37, "UK": 0.7, "Canada": 0.75, "Australia": 0.68, "India": 0.38, "Thailand": 0.42, "Philippines": 0.39, "Vietnam": 0.49, "Poland": 0.76, "Mexico": 0.47, "Brazil": 0.54, "Colombia": 0.36, "South Africa": 0.54 }, "intelligence": "Leads the labour crew under the construction coordinator, distinct from that department head rate. Lumber, hardware and shop time are separate construction lines, and load-in or load-out days sit outside shoot days." }
    ];
    ...
    var _MASTER_EQUIPMENT_INDEX = [
        ...
        /* ========= ENG / SYSTEM CAMERAS (Phase 205, research 2026-07-28) =========
           Gap: the table held cinema bodies (FX6/FX9) and PTZ heads but no
           shoulder-mount ENG or 2/3in system cameras with box lenses, which are
           what actually shoots conferences, sport and live events. Handheld ENG
           derived from published multi-day rentals; system-camera tier anchored on
           a listed chain price. Box lenses are quote-only at every rental house
           checked, so those are ESTIMATE from tier position. */
        { "description": "Sony PXW-Z280 ENG Camcorder", "unit": "Day", "baseRate": 130, "category": "live", "multipliers": _EQUIPMENT_FIXED_MULTIPLIERS, "intelligence": "VERIFIED, LensProToGo $353 for a 4-day rental on the 4K 3-CMOS 1/2in XDCAM handheld; day-equivalent ~$120-140. Workhorse run-and-gun ENG body for conference and news coverage." },
        { "description": "Sony PXW-Z750 Shoulder ENG Camcorder", "unit": "Day", "baseRate": 265, "category": "live", "multipliers": _EQUIPMENT_FIXED_MULTIPLIERS, "intelligence": "VERIFIED, Lensrentals $1,324 for a 7-day rental on the 2/3in shoulder-mount 4K broadcast camcorder; day-equivalent ~$190 at weekly, ~$265 at single-day rental-house pricing." },
        { "description": "Panasonic AG-CX350 ENG Camcorder", "unit": "Day", "baseRate": 95, "category": "live", "multipliers": _EQUIPMENT_FIXED_MULTIPLIERS, "intelligence": "ESTIMATE, 1in sensor 4K handheld with 20x zoom, NDI and streaming built in. Priced below the Z280 tier consistent with lower street price and smaller sensor." },
        { "description": "JVC GY-HC500 ENG Camcorder", "unit": "Day", "baseRate": 95, "category": "live", "multipliers": _EQUIPMENT_FIXED_MULTIPLIERS, "intelligence": "ESTIMATE, 1in 4K connected-cam handheld, streaming-capable. Peer of the AG-CX350 tier." },
        { "description": "Broadcast System Camera Chain (2/3in + CCU)", "unit": "Day", "baseRate": 1450, "category": "live", "multipliers": _EQUIPMENT_FIXED_MULTIPLIERS, "intelligence": "VERIFIED, High End TV lists the Sony HDC-3500 4K/HDR multiformat chain with HDCU-3100 CCU at $1,450/day. Hard-wired studio and OB tier: body, CCU, fibre, viewfinder. Lens, tripod and cabling price separately." },
        { "description": "Broadcast Camera Carrypack (Chain + Tripod)", "unit": "Day", "baseRate": 1750, "category": "live", "multipliers": _EQUIPMENT_FIXED_MULTIPLIERS, "intelligence": "ESTIMATE, system camera chain plus heavy sticks, pan bar and on-camera monitoring, as rental houses bundle a carrypack. Verified chain at $1,450 plus tripod and accessory uplift." },
        { "description": "Box Lens (Long Zoom 80x-107x)", "unit": "Day", "baseRate": 850, "category": "live", "multipliers": _EQUIPMENT_FIXED_MULTIPLIERS, "intelligence": "ESTIMATE, Fujinon UA107x8.4 and UA80x9 class 4K 2/3in field glass (8.4-900mm), the long lenses at the back of a hall or stadium. Every rental house checked lists these quote-only with no published day rate. Priced from tier position: below a full camera chain, well above portable ENG glass. Confirm with the house before quoting a client." },
        { "description": "Box Lens (Portable Zoom 20x-40x)", "unit": "Day", "baseRate": 275, "category": "live", "multipliers": _EQUIPMENT_FIXED_MULTIPLIERS, "intelligence": "ESTIMATE, 2/3in ENG-style portable broadcast zoom with servo, the standard fit on a system camera when a full box lens is not needed. Quote-only class; priced between ENG glass and the long-zoom tier." },
        { "description": "Heavy Duty Tripod (Broadcast Sticks)", "unit": "Day", "baseRate": 125, "category": "live", "multipliers": _EQUIPMENT_FIXED_MULTIPLIERS, "intelligence": "ESTIMATE, 100mm or 150mm bowl fluid head rated for a system camera and box lens. Well above the prosumer video-head tier already listed." }
    ];
    ...
    var mBTOG = {
        ...
        loadRates: function (forceReseed) {
            ...
            var CURRENT_VERSION = '2026.07.28_colorist_hourly_fix_v1';
        ...
        */
        ...
        getJurisdictionByRegion: function (region) {
            var jMap = {
                ...
                'Philippines':  { name: 'Philippines (FDI Film Incentive)',    incentiveRate: 20,   minSpend: 0,       intelligence: 'Up to 20% on local spend. Crew scalars from regional day rate surveys, medium confidence.' },
