...
(function() {
  ...
  namespace.icons.stages = (function() {
    var d = "M18 15V6a2 2 0 00-2-2H7a2 2 0 00-2 2v9m16 0V19a2 2 0 01-2 2H5a2 2 0 01-2-2v-4m16 0a2 2 0 01-2 2h-2m-8-2h2m0 0v2m0-2h2m-8-2h2m0 0v2m-4-2h2m0 0v2m10-6h2m-11 0h2m-3 0h2M21 15V21";
  ...
  namespace.icons.docs = (function() {
    var d = "M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8zM14 2v6h6M16 13H8M16 17H8M10 9H8";
    return '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="' + d + '"></path></svg>';
  })();

  // 🔓 OpenGate / Unlock
  namespace.icons.unlock = (function() {
    var d = "M19 15v3a2 2 0 01-2 2H5a2 2 0 01-2-2v-3m18-2V3a2 2 0 00-2-2H5a2 2 0 00-2 2v3m2-3v5h2";
  ...
  namespace.icons.movieClapper = (function() {
    var d = "M4 15s1-1 4-1 5 2 5 2 4-1 4-1M4 15v-1a3 3 0 013-3h10a3 3 0 013 3v1m-12 0a4 4 0 014-4h0a4 4 0 014 4m-8 1v1a3 3 0 003 3h10a3 3 0 003-3v-1";
    return '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="' + d + '"></path></svg>';
  })();

  // Presets / Ruler
  namespace.icons.ruler = (function() {
    var d = "M2 12h20M2 12l5-5m-5 5l5 5M12 2v20M12 2l5 5m-5-5l-5 5";
    return '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="' + d + '"></path></svg>';
  })();

  // Call Sheet / Clipboard
  namespace.icons.clipboard = (function() {
    var d = "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01";
    return '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="' + d + '"></path></svg>';
  })();

  // Book / PDF
  namespace.icons.book = (function() {
    var d = "M4 19.5A2.5 2.5 0 016.5 17H20M6.5 17a2.5 2.5 0 015 0h11.5A2.5 2.5 0 0020 14.5v-1A2.5 2.5 0 0017.5 11h-2.5a2.5 2.5 0 00-5 0v1H6.5a2.5 2.5 0 01-2.5-2.5v-1.8a2.5 2.5 0 012.5-2.5h15.5a2.5 2.5 0 002.5-2.5v-1A2.5 2.5 0 0020 2.5H6.5a2.5 2.5 0 00-2.5 2.5V11h-2.5A2.5 2.5 0 004 13.5v1.8z";
    return '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="' + d + '"></path></svg>';
  })();
  ...
  namespace.icons.trash = (function() {
    var d = "M3 6h18M19 6v14a2 2 0 01-2 2H7a2 2 0 01-2-2V6m3 0V4a2 2 0 012-2h4a2 2 0 012 2v2M10 11v6M14 11v6";
    return '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="' + d + '"></path></svg>';
  })();

  // Email
  namespace.icons.email = (function() {
    var d = "M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z M22 6l-10 7L2 6";
    return '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="' + d + '"></path></svg>';
  })();

  // Phone
  namespace.icons.phone = (function() {
    var d = "M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07 19.5 19.5 0 01-6-6 19.79 19.79 0 01-3.07-8.67A2 2 0 014.11 2h3a2 2 0 012 1.72 12.84 12.84 0 00.7 2.81 2 2 0 01-.45 2.11L8.09 9.91a16 16 0 006 6l1.17-1.18a2 2 0 012.11-.45 12.84 12.84 0 002.81.7A2 2 0 0122 16.92z";
    return '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="' + d + '"></path></svg>';
  })();

  // Add / Plus
  namespace.icons.plus = (function() {
    var d = "M12 5v14M5 12h14";
    return '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="' + d + '"></polyline></svg>';
  })();

  // Dashboard / Layout
  namespace.icons.dashboard = (function() {
    var d = "M3 3h7v7H3zM14 3h7v7h-7zM14 14h7v7h-7zM3 14h7v7H3z";
  ...
  namespace.icons.menu = (function() {
    var d = "M3 12h18M3 6h18M3 18h18";
    return '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="' + d + '"></polyline></svg>';
  })();

  // Refresh / Reload
  namespace.icons.refresh = (function() {
    var d = "M23 4v6h-6M1 20v-6h6M3.51 9a9 9 0 0114.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0020.49 15M23 20v-6h-6";
    return '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="' + d + '"></polyline></svg>';
  })();

  // Lightning / Performance
  namespace.icons.lightning = (function() {
    var d = "M13 2L3 14h9l-1 8 10-12h-9l1-8z";
    return '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="' + d + '"></path></svg>';
  })();

  // Error / Alert
  namespace.icons.alert = (function() {
    var d = "M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0zM12 9v4M12 17h.01";
    return '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="' + d + '"></path></svg>';
  })();
