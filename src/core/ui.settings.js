...
(function (window) {
    ...
    window.mBT_UI_Settings_getTabContent = function (tabName, subTab) {
        ...
        if (tabName === 'updates') {
            ...
            var currentVersion = updateStatus.localVersion || 'v23.46';
